...
namespace FFV {
    ...
    Swapchain::Swapchain(Device& m_DeviceRef, VkExtent2D extent)
        : m_Device{ m_DeviceRef }, m_WindowExtent{ extent }
    {
        CreateSwapChain();
        CreateImageViews();
        CreateRenderPass();
    ...
    void Swapchain::CreateRenderPass()
    {
        ...
        if (vkCreateRenderPass(m_Device.GetDevice(), &m_RenderPassInfo, nullptr, &m_RenderPass) != VK_SUCCESS)
        {
