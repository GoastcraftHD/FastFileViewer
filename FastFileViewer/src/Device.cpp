...
namespace FFV {
    ...
    void DestroyDebugUtilsMessengerEXT(VkInstance m_Instance, VkDebugUtilsMessengerEXT debugMessenger, const VkAllocationCallbacks* pAllocator)
    {
    ...
    void Device::CreateInstance()
    {
        ...
        {
           std::cerr << "Failed to create m_Instance!" << std::endl;
        }
    ...
    void Device::PickPhysicalDevice()
    {
        ...
        if (deviceCount == 0)
        {
           std::cerr << "Failed to find GPU(s) with Vulkan support!" << std::endl;
        }
    ...
    void Device::HasGflwRequiredInstanceExtensions()
    {
        ...
        for (const auto& required : requiredExtensions)
        {
            ...
            {
               std::cerr << "Missing required glfw extension" << std::endl;
            }
        }
    }
